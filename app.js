...
function getCharacterAvatar(name) {
    ...
    const maleAvatars = [
        // Detailed Darth Vader
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="2 3" opacity="0.2"/>
            <path d="M50,15 C31,15 26,30 26,48 C26,54 28,60 30,64 L22,76 C20,79 23,83 27,83 L73,83 C77,83 80,79 78,76 L70,64 C72,60 74,54 74,48 C74,30 69,15 50,15 Z" fill="currentColor" fill-opacity="0.15"/>
            <path d="M31,48 C31,34 35,22 50,22 C65,22 69,34 69,48 C69,52 68,56 66,59 M34,59 C32,56 31,52 31,48 Z" stroke="currentColor" stroke-width="1" opacity="0.6"/>
            <path d="M50,56 L41,72 L59,72 Z" fill="currentColor"/>
            <circle cx="41" cy="72" r="1.5" fill="currentColor"/>
            <circle cx="59" cy="72" r="1.5" fill="currentColor"/>
            <path d="M34,50 C31,50 31,57 36,57 C41,57 43,53 43,50 Z" fill="currentColor"/>
            <path d="M66,50 C69,50 69,57 64,57 C59,57 57,53 57,50 Z" fill="currentColor"/>
            <path d="M50,15 L50,45" stroke="currentColor" stroke-width="2.5" opacity="0.8"/>
            <path d="M34,44 Q50,40 66,44" stroke="currentColor" stroke-width="2" fill="none"/>
            <line x1="50" y1="56" x2="50" y2="72" stroke="var(--bg-primary, #04090c)" stroke-width="1.5"/>
            <line x1="46" y1="64" x2="54" y2="64" stroke="var(--bg-primary, #04090c)" stroke-width="1"/>
            <line x1="44" y1="68" x2="56" y2="68" stroke="var(--bg-primary, #04090c)" stroke-width="1"/>
        </svg>`,
        // Detailed Boba Fett
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="3 3" opacity="0.25"/>
            ...
            <path d="M35,44 L65,44 L65,49 L53,49 L53,74 L47,74 L47,49 L35,49 Z" fill="currentColor"/>
            <path d="M42,22 Q43,26 40,27" stroke="currentColor" stroke-width="1.5"/>
            <path d="M31,54 L38,58 L38,68 L31,70" stroke="currentColor" stroke-width="1.5" fill="currentColor" fill-opacity="0.3"/>
            <path d="M69,54 L62,58 L62,68 L69,70" stroke="currentColor" stroke-width="1.5" fill="currentColor" fill-opacity="0.3"/>
            <path d="M69,40 L76,40 L76,28 L73,28 L73,25 L79,25 L79,28 L76,28" stroke="currentColor" stroke-width="1.5" fill="currentColor"/>
            <line x1="76" y1="40" x2="76" y2="28" stroke="currentColor" stroke-width="1.5"/>
            <path d="M48,32 L46,36 M52,32 L54,36" stroke="currentColor" stroke-width="1"/>
        </svg>`,
        // Detailed Stormtrooper
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="1 3" opacity="0.2"/>
            ...
            <line x1="47" y1="65" x2="47" y2="72" stroke="var(--bg-primary, #04090c)" stroke-width="1"/>
            <line x1="50" y1="65" x2="50" y2="72" stroke="var(--bg-primary, #04090c)" stroke-width="1"/>
            <line x1="53" y1="65" x2="53" y2="72" stroke="var(--bg-primary, #04090c)" stroke-width="1"/>
            <circle cx="39" cy="63" r="3.5" fill="currentColor"/>
            <circle cx="61" cy="63" r="3.5" fill="currentColor"/>
            <path d="M33,35 L38,37 M67,35 L62,37" stroke="currentColor" stroke-width="1.5" opacity="0.6"/>
        </svg>`,
        // Detailed Hooded Jedi
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="3 3" opacity="0.25"/>
            ...
            <path d="M50,20 C38,20 33,32 33,52 C33,65 30,76 28,82 L72,82 C70,76 67,65 67,52 C67,32 62,20 50,20 Z" fill="currentColor"/>
            <path d="M33,52 Q44,45 50,55 Q56,45 67,52" stroke="var(--bg-primary, #04090c)" stroke-width="1.5" fill="none"/>
            <path d="M22,48 C28,52 32,65 32,82" stroke="currentColor" stroke-width="1" fill="none" opacity="0.5"/>
            <path d="M78,48 C72,52 68,65 68,82" stroke="currentColor" stroke-width="1" fill="none" opacity="0.5"/>
            <path d="M47,74 L53,74 L53,82 L47,82 Z" fill="currentColor"/>
            <circle cx="50" cy="74" r="5" fill="currentColor" opacity="0.4"/>
        </svg>`
    ];
    
    const femaleAvatars = [
        // Detailed Princess Leia
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="2 4" opacity="0.3"/>
            <g fill="currentColor">
                <circle cx="24" cy="46" r="12" opacity="0.8"/>
                <path d="M24,34 C17,34 12,39 12,46 C12,53 17,58 24,58 Z" opacity="0.4"/>
                <circle cx="24" cy="46" r="6" fill="var(--bg-primary, #04090c)"/>
                
                <circle cx="76" cy="46" r="12" opacity="0.8"/>
                <path d="M76,34 C83,34 88,39 88,46 C88,53 83,58 76,58 Z" opacity="0.4"/>
                <circle cx="76" cy="46" r="6" fill="var(--bg-primary, #04090c)"/>
            </g>
            <path d="M34,44 C34,26 42,22 50,22 C58,22 66,26 66,44 C66,32 50,27 34,44 Z" fill="currentColor"/>
            <path d="M50,22 Q42,32 35,44 Q50,34 65,44 Q58,32 50,22" fill="currentColor" opacity="0.5"/>
            <path d="M36,44 Q36,65 50,68 Q64,65 64,44 C64,44 61,38 50,38 C39,38 36,44 36,44 Z" fill="currentColor" fill-opacity="0.15"/>
            <path d="M42,50 Q45,49 48,51" stroke="currentColor" stroke-width="1" fill="none"/>
            <path d="M58,50 Q55,49 52,51" stroke="currentColor" stroke-width="1" fill="none"/>
            <path d="M50,52 L50,58 L48,58" stroke="currentColor" stroke-width="1" fill="none"/>
            <path d="M46,61 Q50,64 54,61" stroke="currentColor" stroke-width="1.2" fill="none"/>
            <path d="M44,67 L38,82 L62,82 L56,67 C56,67 50,71 44,67 Z" fill="currentColor" fill-opacity="0.25"/>
            <path d="M38,82 C44,76 50,78 50,78 C50,78 56,76 62,82" stroke="currentColor" stroke-width="1.5" fill="none"/>
        </svg>`,
        // Detailed Ahsoka Tano
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="1 3" opacity="0.3"/>
            <path d="M38,48 Q38,66 50,68 Q62,66 62,48 C62,40 57,34 50,34 C43,34 38,40 38,48 Z" fill="currentColor" fill-opacity="0.15"/>
            <path d="M50,34 Q45,18 36,12 Q33,12 36,24 Q41,30 50,34 Z" fill="currentColor" fill-opacity="0.75"/>
            <path d="M50,34 Q55,18 64,12 Q67,12 64,24 Q59,30 50,34 Z" fill="currentColor" fill-opacity="0.75"/>
            <path d="M38,15 Q41,18 43,15 M36,20 Q40,24 45,22 M62,15 Q59,18 57,15 M64,20 Q60,24 55,22" stroke="currentColor" stroke-width="2"/>
            <path d="M38,42 Q34,42 28,74 Q32,85 36,78 C36,66 38,54 38,42 Z" fill="currentColor" fill-opacity="0.6"/>
            <path d="M62,42 Q66,42 72,74 Q68,85 64,78 C64,66 62,54 62,42 Z" fill="currentColor" fill-opacity="0.6"/>
            <path d="M36,50 Q31,52 34,56 M36,62 Q30,64 32,68 M64,50 Q69,52 66,56 M64,62 Q70,64 68,68" stroke="currentColor" stroke-width="2.5"/>
            <path d="M37,34 Q50,40 63,34 L50,42 Z" fill="currentColor"/>
            <circle cx="50" cy="38" r="2" fill="var(--bg-primary, #04090c)"/>
            <path d="M42,42 L45,45 L41,47 C41,47 43,45 42,42 Z" fill="currentColor"/>
            <path d="M58,42 L55,45 L59,47 C59,47 57,45 58,42 Z" fill="currentColor"/>
            <path d="M50,56 L50,62 L48,60 Z" fill="currentColor"/>
            <path d="M42,50 Q45,49 48,51 M58,50 Q55,49 52,51" stroke="currentColor" stroke-width="1.2" fill="none"/>
        </svg>`,
        // Detailed Rey
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="40" stroke="currentColor" stroke-width="0.5" stroke-dasharray="2 3" opacity="0.3"/>
            <path d="M38,44 Q38,62 50,65 Q62,62 62,44 C62,35 58,28 50,28 C42,28 38,35 38,44 Z" fill="currentColor" fill-opacity="0.15"/>
            <g fill="currentColor">
                <circle cx="50" cy="24" r="6" opacity="0.8"/>
                <path d="M50,18 C46,18 43,21 43,24 C43,27 46,30 50,30 Z" opacity="0.4"/>
                <circle cx="50" cy="15" r="5" opacity="0.9"/>
                <circle cx="50" cy="31" r="5.5" opacity="0.75"/>
            </g>
            <path d="M37,36 C35,42 35,52 35,52" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
            <path d="M63,36 C65,42 65,52 65,52" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
            <path d="M38,36 C38,28 44,24 50,24 C56,24 62,28 62,36 C62,32 50,28 38,36 Z" fill="currentColor"/>
            <path d="M43,48 Q46,47 48,49 M57,48 Q54,47 52,49" stroke="currentColor" stroke-width="1" fill="none"/>
            <path d="M46,56 Q50,59 54,56" stroke="currentColor" stroke-width="1.2" fill="none"/>
            <path d="M43,64 L30,82 L70,82 L57,64 Z" fill="currentColor" fill-opacity="0.25"/>
            <path d="M44,65 L30,82" stroke="currentColor" stroke-width="2"/>
            <path d="M56,65 L70,82" stroke="currentColor" stroke-width="2"/>
        </svg>`,
        // Detailed Bo-Katan
        `<svg viewBox="0 0 100 100" fill="none" stroke="currentColor" stroke-width="1.5" style="width: 100%; height: 100%;">
            <circle cx="50" cy="50" r="41" stroke="currentColor" stroke-width="0.5" stroke-dasharray="3 3" opacity="0.25"/>
            <path d="M50,18 C33,18 32,28 32,45 L32,74 C32,78 35,81 40,81 L60,81 C65,81 68,78 68,74 L68,45 C68,28 67,18 50,18 Z" fill="currentColor" fill-opacity="0.15"/>
            ...
            <path d="M32,54 C35,55 37,59 37,64 L37,74 L32,74 Z" fill="currentColor" fill-opacity="0.3"/>
            <path d="M68,54 C65,55 63,59 63,64 L63,74 L68,74 Z" fill="currentColor" fill-opacity="0.3"/>
            <path d="M50,22 L46,28 Q50,26 54,28 Z" fill="currentColor"/>
            <path d="M32,45 L29,45 L29,55 L32,55 M68,45 L71,45 L71,55 L68,55" stroke="currentColor" stroke-width="1.5"/>
            <line x1="29" y1="50" x2="32" y2="50" stroke="currentColor" stroke-width="1"/>
            <line x1="71" y1="50" x2="68" y2="50" stroke="currentColor" stroke-width="1"/>
            <path d="M50,18 Q50,26 50,38" stroke="currentColor" stroke-width="2" opacity="0.8"/>
        </svg>`
    ];
